...
const POLICY_DATA = {
  "HR POLICY": [
    ...
    { title:"SWD Code of Conduct Policy", link:"/company policies/_18_28_2f4a2728a8b54167_SWD-Code of Conduct Policy.pdf", description:"Standards of professional conduct expected of all employees" },
    { title:"SWD Sexual Harassment Policy", link:"/company policies/_19_47_bb01b0d300d84033_SWD-Sexual Harasment Policy.pdf", description:"Workplace harassment prevention and redressal procedures" },
    ...
    { title:"Customer Referral Incentives for Employees", link:"/company policies/_27_44_7b2990c3ad324662_Customer Referral Incentives for Employees.pdf", description:"Incentive structure for employee-driven customer referrals" },
    ...
    { title:"SWD Whistleblower Policy", link:"/company policies/_20_17_ebb5612915fa4f1e_SWD Whistleblower Policy.pdf", description:"Whistleblower protection and reporting procedures" },
    ...
    { title:"Flexible Work Schedule Policy", link:"/company policies/_7_30_da688058dfdf4f0d_Flexible Work Schedule Policy.pdf", description:"Guidelines for flexible working arrangements and remote work" },
  ],
  "ADMIN POLICY": [
  ...
  "IT POLICY": [
    { title:"Smartworld IT Policy", link:"/company policies/_51_26_7fc3aa1e08134737_Smartworld IT Policy.pdf", description:"Information technology usage, security and data protection guidelines" },
  ],
  "HOLIDAY LISTS": [
    { title:"Holiday List 2026", link:"/company policies/_24_20_bf9031eb49c844ec_Holiday List -2026.pdf", description:"Official list of company holidays for the year 2026" },
    { title:"Holiday List 2025", link:"/company policies/_49_28_173e71137f02455e_Holiday List - 2025.pdf", description:"Official list of company holidays for the year 2025" },
    { title:"Holiday List 2024", link:"/company policies/Proposed Holiday List - 2024.xlsx.pdf", description:"Official list of company holidays for the year 2024" },
    { title:"Holiday List 2023", link:"/company policies/_2_54_5b5b8a0641c54253_Holiday List 2023.pdf", description:"Official list of company holidays for the year 2023" },
  ],
};

const SECTION_COLORS = { "HR POLICY":"#00d4ff", "ADMIN POLICY":"#7b2fff", "IT POLICY":"#00ff88", "HOLIDAY LISTS":"#ffb800" };

const Policies = () => {
  const [expanded, setExpanded] = useState({ "HR POLICY": true, "ADMIN POLICY": false, "IT POLICY": false, "HOLIDAY LISTS": false });
